...
package io.authup.android.apps.authenticator.dataimport;

import io.authup.android.apps.authenticator.dataexport.IExportServiceV2;
...
public class ExportServiceBasedImportController implements ImportController {
  ...
  private static final String OLD_APP_PACKAGE_NAME = "io.authup.android.apps.authenticator";
